...
import { ITEM_TYPE, ATTRIBUTES } from './constants.js'
...
Hooks.once('tokenActionHudCoreApiReady', async (coreModule) => {
    ...
    ActionHandler = class ActionHandler extends coreModule.api.ActionHandler {
        ...
        async buildResting () {
            ...
            actions.push({
                id: 'roundRest',
                name: coreModule.api.Utils.i18n('tokenActionHud.dragonbane.roundRest') || 'Round Rest',
                listName: coreModule.api.Utils.i18n('tokenActionHud.dragonbane.roundRest') || 'Round Rest',
                tooltip: coreModule.api.Utils.i18n('tokenActionHud.dragonbane.tooltips.roundRest') || 'Restores 1D6 WP',
            ...
            actions.push({
                id: 'stretchRest',
                name: coreModule.api.Utils.i18n('tokenActionHud.dragonbane.stretchRest') || 'Stretch Rest',
                listName: coreModule.api.Utils.i18n('tokenActionHud.dragonbane.stretchRest') || 'Stretch Rest',
                tooltip: coreModule.api.Utils.i18n('tokenActionHud.dragonbane.tooltips.stretchRest') || 'Restores 1D6 HP (2D6 with Healing), 1D6 WP, and removes 1 condition',
            ...
            actions.push({
                id: 'shiftRest',
                name: coreModule.api.Utils.i18n('tokenActionHud.dragonbane.shiftRest') || 'Shift Rest',
                listName: coreModule.api.Utils.i18n('tokenActionHud.dragonbane.shiftRest') || 'Shift Rest',
                tooltip: coreModule.api.Utils.i18n('tokenActionHud.dragonbane.tooltips.shiftRest') || 'Restores all HP, all WP, and removes all conditions',
            ...
            actions.push({
                id: 'passOneShift',
                name: coreModule.api.Utils.i18n('tokenActionHud.dragonbane.passOneShift') || 'Pass One Shift of Time',
                listName: coreModule.api.Utils.i18n('tokenActionHud.dragonbane.passOneShift') || 'Pass One Shift of Time',
                tooltip: coreModule.api.Utils.i18n('tokenActionHud.dragonbane.tooltips.passOneShift') || 'Advances time without resting, making rest actions available again',
        ...
        async buildOther () {
            ...
            if (this.actorType === 'character' || this.actorType === 'npc') {
                actions.push({
                    id: 'lightTest',
                    name: coreModule.api.Utils.i18n('tokenActionHud.dragonbane.lightTest'),
                    listName: coreModule.api.Utils.i18n('tokenActionHud.dragonbane.lightTest'),
            ...
            if (this.actorType === 'character') {
                actions.push({
                    id: 'severeInjury',
                    name: coreModule.api.Utils.i18n('tokenActionHud.dragonbane.severeInjury'),
                    listName: coreModule.api.Utils.i18n('tokenActionHud.dragonbane.severeInjury'),
        ...
        /**
         * Build conditions actions (attribute conditions and status effects)
         */
        async buildConditions () {
            ...
            for (const effect of statusEffects) {
                ...
                if (/^action[1-9]$/.test(effectId) || effectName === 'Action') continue
                ...
                // Create action using utility
                const action = this._createConditionAction(effect, isActive, attributeKey)
            ...
            if (regularActions.length > 0) {
                this.addActions(regularActions, { id: 'statusEffects', type: 'system' })
            }
        }
        ...
        async buildSystemActions (groupIds) {
            ...
            this.showEquippedWeaponsOnly = Utils.getSetting('showEquippedWeaponsOnly')
            ...
            Object.assign(this, {
                ...
                _createConditionalAction: actionUtilities._createConditionalAction.bind(this),
                _tryDragonbaneActionOrSheet: actionUtilities._tryDragonbaneActionOrSheet.bind(this),
                _createConditionAction: actionUtilities._createConditionAction.bind(this)
            })
            ...
            Object.assign(this, {
                ...
                performSevereInjuryRoll: actionDialogs.performSevereInjuryRoll.bind(this),
                buildSevereInjuryChatContent: actionDialogs.buildSevereInjuryChatContent.bind(this),
            ...
            Object.assign(this, {
                ...
                handleRestUnavailableAction: actionHandlers.handleRestUnavailableAction.bind(this),
                handleLightTestAction: actionHandlers.handleLightTestAction.bind(this),
                handleSevereInjuryAction: actionHandlers.handleSevereInjuryAction.bind(this),
                handleCombatSkillAction: actionHandlers.handleCombatSkillAction.bind(this),
                ...
                handleMonsterWeaponDamage: actionHandlers.handleMonsterWeaponDamage.bind(this)
            })
            ...
            Object.assign(this, {
                ...
                buildMonsterWeaponDamage: actionBuilders.buildMonsterWeaponDamage.bind(this),
         ...
         * @returns {void}
         */
        _buildItemActions(itemType, actionTypeId, nameFormatter, filterCallback, handlerName, groupId) {
            ...
            const actions = [...items].map(([itemId, itemData]) => {
                ...
                return this._createItemAction(itemId, name, itemData, actionTypeId, handlerName)
            })
