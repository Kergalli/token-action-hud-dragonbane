 ...
 * Enhanced with categorized condition support
 */
    ...
    layout: [
      ...
      },
      {
        ...
        groups: [
          ...
          {
            ...groups.monsterAttacksSpecific,
            nestId: "monster_attacksSpecific",
          },
      ...
      },
      {
        ...
        groups: [
          {
            ...groups.attributeConditions,
            nestId: "conditions_attributeConditions",
          },
          { ...groups.generalEffects, nestId: "conditions_generalEffects" },
          { ...groups.spellEffects, nestId: "conditions_spellEffects" },
          { ...groups.heroicAbilities, nestId: "conditions_heroicAbilities" },
      ...
      },
      {
        ...
        groups: [
          ...
          { ...groups.currency, nestId: "inventory_currency" },
        ],
      },
      {
        nestId: "utility",
        ...
        groups: [
          ...
          { ...groups.journeyActions, nestId: "utility_journeyActions" },
