...
export function createActionUtilities(coreModule) {
    return {
         ...
         */
        _createItemAction: function (id, name, itemData, actionTypeId, handlerName, extraProps = {}) {
            const baseAction = {
                id,
                name,
                listName: name,
            ...
            const useRollHandler = ['weapon', 'spell', 'ability', 'skill'].includes(actionTypeId)
         ...
         * @returns {object} Action object
         */
        _createSimpleAction: function (id, name, img, actionTypeId, handlerName, extraProps = {}) {
            const baseAction = {
                id,
                name,
                listName: name,
         ...
         * @returns {object} Action object
         */
        _createConditionalAction: function (id, name, img, condition, cssClass, actionTypeId, handlerName) {
            return this._createSimpleAction(id, name, img, actionTypeId, handlerName, {
        ...
        _tryDragonbaneActionOrSheet: async function (itemData, methodName) {
            try {
                ...
                if (game.dragonbane && typeof game.dragonbane[methodName] === 'function') {
